...
enum JMessageType
{
	...
	J_MESSAGE_DB_DELETE,
	J_MESSAGE_DB_QUERY,
	J_MESSAGE_TRANSFORMATION_OBJECT_CREATE,
	J_MESSAGE_TRANSFORMATION_OBJECT_DELETE,
	J_MESSAGE_TRANSFORMATION_OBJECT_READ,
	J_MESSAGE_TRANSFORMATION_OBJECT_STATUS,
	J_MESSAGE_TRANSFORMATION_OBJECT_WRITE
};
